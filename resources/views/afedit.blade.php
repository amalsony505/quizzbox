...
<body background="https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260" 
    ...
    <form action="/afupdate" method="post">
    {{ csrf_field() }}
    ...
    <table class="table table-dark table-borderless">
      ...
      <label><h3>Course:</h3></label>
        <input name="course" value="{{$Info->course}}"  type="text" placeholder="Enter email" class="form-control" id="ip2"/>
